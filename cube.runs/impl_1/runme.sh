...
HD_PWD='D:/XILINX/cube/cube.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cube_finder_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cube_finder_tb.tcl -notrace
