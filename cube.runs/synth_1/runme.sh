...
HD_PWD='D:/XILINX/cube/cube.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cubenormal.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cubenormal.tcl
